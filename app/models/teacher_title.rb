...
class TeacherTitle < ActiveRecord::Base
  ...
  TITLES_en = ["Chair Person", "Distinguished Chair Proffesor", "Visiting Proffesor", 
               "Honory Proffesor", "Proffesor", "Associate Proffesor", "Assistant Proffesor",
               "Adjunct Proffesor", "Adjunct Associate Proffesor", "Adjunct Assisitant Proffesor",
               "Proffessional Practice Teacher"]
